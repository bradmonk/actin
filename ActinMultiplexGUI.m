...
doP5 = get(handles.FinalPlots,'Value');
%---
DOES = [doP1 doP2 doP3 doP4 doP5];
%-------
...
AMX50  = str2double(get(handles.T2s,'String'));
AMX51  = str2double(get(handles.T3s,'String'));
AMX52  = str2double(get(handles.T4s,'String'));
AMX53  = str2double(get(handles.T5s,'String'));
AMX54  = str2double(get(handles.T2pct,'String'));
AMX55  = str2double(get(handles.T3pct,'String'));
AMX56  = str2double(get(handles.T4pct,'String'));
AMX57  = str2double(get(handles.T5pct,'String'));
...
AMX74  = str2double(get(handles.uM_ThymosinActin,'String'));
AMX75  = str2double(get(handles.Ka_Thymosin,'String'));
AMX76  = str2double(get(handles.Kd_Thymosin,'String'));
AMX77  = str2double(get(handles.Tbaseline,'String'));
AMX78  = str2double(get(handles.TbaselinePct,'String'));
...
AMX86  = str2double(get(handles.Ka_Thymosin_T2,'String'));
AMX87  = str2double(get(handles.Ka_Thymosin_T3,'String'));
AMX88  = str2double(get(handles.Ka_Thymosin_T4,'String'));
AMX89  = str2double(get(handles.Ka_Thymosin_T5,'String'));

AMX90  = str2double(get(handles.Kd_Thymosin_T2,'String'));
AMX91  = str2double(get(handles.Kd_Thymosin_T3,'String'));
AMX92  = str2double(get(handles.Kd_Thymosin_T4,'String'));
AMX93  = str2double(get(handles.Kd_Thymosin_T5,'String'));

AMX94  = str2double(get(handles.D_Thym_Basal,'String'));
AMX95  = str2double(get(handles.Pct_TA_Basal,'String'));

AMX96  = str2double(get(handles.D_Thym_T2,'String'));
AMX97  = str2double(get(handles.D_Thym_T3,'String'));
AMX98  = str2double(get(handles.D_Thym_T4,'String'));
AMX99  = str2double(get(handles.D_Thym_T5,'String'));
AMX100  = str2double(get(handles.Pct_TA_T2,'String'));
AMX101  = str2double(get(handles.Pct_TA_T3,'String'));
AMX102  = str2double(get(handles.Pct_TA_T4,'String'));
AMX103  = str2double(get(handles.Pct_TA_T5,'String'));
AMX104  = str2double(get(handles.ThymTimeStart,'String'));



%---
AMX = { AMX1,  AMX2,  AMX3,  AMX4,  AMX5,  AMX6,  AMX7,  AMX8,  AMX9, AMX10, ...
	   AMX11, AMX12, AMX13, AMX14, AMX15, AMX16, AMX17, AMX18, AMX19, AMX20, ...
	   AMX21, AMX22, AMX23, AMX24, AMX25, AMX26, AMX27, AMX28, AMX29, AMX30, ...
	   AMX31, AMX32, AMX33, AMX34, AMX35, AMX36, AMX37, AMX38, AMX39, AMX40, ...
	   AMX41, AMX42, AMX43, AMX44, AMX45, AMX46, AMX47, AMX48, AMX49, AMX50, ...
	   AMX51, AMX52, AMX53, AMX54, AMX55, AMX56, AMX57, AMX58, AMX59, AMX60, ...
	   AMX61, AMX62, AMX63, AMX64, AMX65, AMX66, AMX67, AMX68, AMX69, AMX70, ...
	   AMX71, AMX72, AMX73, AMX74, AMX75, AMX76, AMX77, AMX78, AMX79, AMX80, ...
       AMX81, AMX82, AMX83, AMX84, AMX85, AMX86, AMX87, AMX88, AMX89, AMX90, ...
       AMX91, AMX92, AMX93, AMX94, AMX95, AMX96, AMX97, AMX98, AMX99, AMX100, ...
       AMX101, AMX102, AMX103, AMX104, ...
       };
%-------
...
AMS12 = get(handles.FinalPlots,'Value');
%--
AMS = {AMS1, AMS2, AMS3, AMS4, AMS5, AMS6, AMS7, AMS8, AMS9, AMS10, AMS11, AMS12};
%-------
...
guidata(hObject,handles)
%---
function Tbaseline(hObject, eventdata, handles)
Tbaseline = get(hObject, 'Value');
 
handles.guidata.Tbaseline = Tbaseline;
guidata(hObject,handles)
%---
...
guidata(hObject,handles)
%---
function T5s(hObject, eventdata, handles)
T5s = get(hObject, 'Value');
 
handles.guidata.T5s = T5s;
guidata(hObject,handles)
%---
function TbaselinePct(hObject, eventdata, handles)
TbaselinePct = get(hObject, 'Value');
 
handles.guidata.TbaselinePct = TbaselinePct;
guidata(hObject,handles)
%---
...
guidata(hObject,handles)
%---
function T5pct(hObject, eventdata, handles)
T5pct = get(hObject, 'Value');

handles.guidata.T5pct = T5pct;
guidata(hObject,handles)
%---
...
guidata(hObject,handles)
%---
function FinalPlots(hObject, eventdata, handles)
FinalPlots = get(hObject, 'Value');
 
handles.guidata.FinalPlots = FinalPlots;
guidata(hObject,handles)
%---
...
guidata(hObject,handles)
%---
function uM_ThymosinActin(hObject, eventdata, handles)
uM_ThymosinActin = get(hObject, 'Value');
 
handles.guidata.uM_ThymosinActin = uM_ThymosinActin;
guidata(hObject,handles)
%---
...
function Ka_Thymosin_T2(hObject, eventdata, handles)
Ka_Thymosin_T2 = get(hObject, 'Value');
 
handles.guidata.Ka_Thymosin_T2 = Ka_Thymosin_T2;
guidata(hObject,handles)
%---
function Ka_Thymosin_T3(hObject, eventdata, handles)
Ka_Thymosin_T3 = get(hObject, 'Value');
 
handles.guidata.Ka_Thymosin_T3 = Ka_Thymosin_T3;
guidata(hObject,handles)
%---
function Ka_Thymosin_T4(hObject, eventdata, handles)
Ka_Thymosin_T4 = get(hObject, 'Value');
 
handles.guidata.Ka_Thymosin_T4 = Ka_Thymosin_T4;
guidata(hObject,handles)
%---
function Ka_Thymosin_T5(hObject, eventdata, handles)
Ka_Thymosin_T5 = get(hObject, 'Value');
 
handles.guidata.Ka_Thymosin_T5 = Ka_Thymosin_T5;
guidata(hObject,handles)
%---

function Kd_Thymosin_T2(hObject, eventdata, handles)
Kd_Thymosin_T2 = get(hObject, 'Value');
 
handles.guidata.Kd_Thymosin_T2 = Kd_Thymosin_T2;
guidata(hObject,handles)
%---
function Kd_Thymosin_T3(hObject, eventdata, handles)
Kd_Thymosin_T3 = get(hObject, 'Value');
 
handles.guidata.Kd_Thymosin_T3 = Kd_Thymosin_T3;
guidata(hObject,handles)
%---
function Kd_Thymosin_T4(hObject, eventdata, handles)
Kd_Thymosin_T4 = get(hObject, 'Value');
 
handles.guidata.Kd_Thymosin_T4 = Kd_Thymosin_T4;
guidata(hObject,handles)
%---
function Kd_Thymosin_T5(hObject, eventdata, handles)
Kd_Thymosin_T5 = get(hObject, 'Value');
 
handles.guidata.Kd_Thymosin_T5 = Kd_Thymosin_T5;
guidata(hObject,handles)
%---

function D_Thym_Basal(hObject, eventdata, handles)
D_Thym_Basal = get(hObject, 'Value');
 
handles.guidata.D_Thym_Basal = D_Thym_Basal;
guidata(hObject,handles)
%---
function D_Thym_T2(hObject, eventdata, handles)
D_Thym_T2 = get(hObject, 'Value');
 
handles.guidata.D_Thym_T2 = D_Thym_T2;
guidata(hObject,handles)
%---
function D_Thym_T3(hObject, eventdata, handles)
D_Thym_T3 = get(hObject, 'Value');
 
handles.guidata.D_Thym_T3 = D_Thym_T3;
guidata(hObject,handles)
%---
function D_Thym_T4(hObject, eventdata, handles)
D_Thym_T4 = get(hObject, 'Value');
 
handles.guidata.D_Thym_T4 = D_Thym_T4;
guidata(hObject,handles)
%---
function D_Thym_T5(hObject, eventdata, handles)
D_Thym_T5 = get(hObject, 'Value');
 
handles.guidata.D_Thym_T5 = D_Thym_T5;
guidata(hObject,handles)
%---


function Pct_TA_Basal(hObject, eventdata, handles)
Pct_TA_Basal = get(hObject, 'Value');
 
handles.guidata.Pct_TA_Basal = Pct_TA_Basal;
guidata(hObject,handles)
%---
function Pct_TA_T2(hObject, eventdata, handles)
Pct_TA_T2 = get(hObject, 'Value');
 
handles.guidata.Pct_TA_T2 = Pct_TA_T2;
guidata(hObject,handles)
%---
function Pct_TA_T3(hObject, eventdata, handles)
Pct_TA_T3 = get(hObject, 'Value');
 
handles.guidata.Pct_TA_T3 = Pct_TA_T3;
guidata(hObject,handles)
%---
function Pct_TA_T4(hObject, eventdata, handles)
Pct_TA_T4 = get(hObject, 'Value');
 
handles.guidata.Pct_TA_T4 = Pct_TA_T4;
guidata(hObject,handles)
%---
function Pct_TA_T5(hObject, eventdata, handles)
Pct_TA_T5 = get(hObject, 'Value');
 
handles.guidata.Pct_TA_T5 = Pct_TA_T5;
guidata(hObject,handles)
%---
function ThymTimeStart(hObject, eventdata, handles)
ThymTimeStart = get(hObject, 'Value');
 
handles.guidata.ThymTimeStart = ThymTimeStart;
guidata(hObject,handles)
%---
